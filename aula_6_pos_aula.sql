...
CREATE TABLE teste.aluno(
	id_aluno INTEGER PRIMARY KEY,-- unique, not null
	nome VARCHAR(30),
	id_curso INTEGER
)
...
INSERT INTO teste.aluno (id_aluno, nome, id_curso) VALUES (1,'joao', 1), 
													(2,'paulo', 2);

-- vai dar problema, pois o id_aluno 1 já  existe na base
INSERT INTO teste.aluno (id_aluno, nome, id_curso) VALUES (1, 'Ana', 4);


DROP TABLE teste.aluno;
...
INSERT INTO teste.aluno (nome, id_curso) VALUES ('joao', 1), ('paulo', 2);

INSERT INTO teste.aluno (nome, id_curso) VALUES ('Ana', 4);
INSERT INTO teste.aluno (id_aluno, nome, id_curso) VALUES (6, 'flavia', 4);

INSERT INTO teste.aluno (nome, id_curso) VALUES ('show', 5);

DELETE FROM teste.aluno WHERE id_aluno = 7;

INSERT INTO teste.aluno (nome, id_curso) VALUES ('marcio', 5);

INSERT INTO teste.aluno (nome, id_curso) VALUES ('leonardo', 1);

CREATE TABLE teste.curso(
	id_curso SERIAL PRIMARY KEY,
	nome VARCHAR(30)
);

INSERT INTO teste.curso (nome) VALUES ('ciencia de dados'), ('engenharia de dados');
...
CREATE TABLE teste.aluno(
	...
	nome VARCHAR(30),
	id_curso INTEGER,
	FOREIGN KEY (id_curso) REFERENCES teste.curso(id_curso)
)
...
INSERT INTO teste.curso(nome) VALUES ('analise de dados'), ('arquitetura de dados')

INSERT INTO teste.aluno (nome, id_curso) VALUES ('Ana', 4);

UPDATE teste.curso SET id_curso = 7 WHERE nome = 'ciencia de dados';
...
UPDATE teste.aluno SET id_curso = 4 WHERE id_aluno = 1;

---- criando tabelas antes normalizadas
CREATE SCHEMA ada;
