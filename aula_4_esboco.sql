...
-- criei uma tabela no schema ada
CREATE TABLE ada.carroes (
	id_carro INTEGER, 
	nome VARCHAR(40), 
	preco NUMERIC
);

-- query para ler os dados da tabela
SELECT * FROM ada.carroes;

-- inserir dados na tabela
INSERT INTO ada.carroes VALUES (1, 'celta', 15.9);

INSERT INTO ada.carroes VALUES ('2','ka', 14.9);

-- errar tipagem de forma extrema, dá ruim 
INSERT INTO ada.carroes VALUES ('amelia','ka', 14.9);

INSERT INTO ada.carroes (nome, preco) VALUES ('uno', 67.0);

INSERT INTO ada.carroes (nome) VALUES ( 'corsa');

SELECT * FROM ada.carroes;

UPDATE ada.carroes SET nome = 'ferrari' WHERE id_carro = 1;

UPDATE ada.carroes SET nome = 'suceso';

DELETE FROM ada.carroes WHERE id_carro = 2;

SELECT * FROM ada.carroes;

DELETE FROM ada.carroes;
...
SELECT * FROM ada.cursos;

INSERT INTO ada.cursos (curso, valor_curso) VALUES ('engenharia de dados', 60),
('ciencia de dados', 70),
('analise de dados', 50),
('arquiteto de dados', 80)
...
, ('55207096189', 'isabela', 'bueno', '2023-03-22', 1, 'Avenida Brasilia', 1185, '740040561', '230351268')
, ('02456915690', 'kelvel', 'pichinini', '2023-03-23', 1, 'Rua são paulo', 9470, '538617705', '0')
, ('51865906231', 'lucas', 'voltolini', '2023-03-24', 5, 'Rua são paulo ', 3800, '613900746', '909322964')
, ('20671422357', 'janaina', 'delgado', '2023-03-25', 6, 'Rua teobaldo', 9317, '789048901', '885432495')
...
, ('17412432561', 'michel', 'solza', '2023-03-28', 7, 'tua baraão tinha uva', 8347, '827235134', '314861183')
, ('18167196135', 'mike', 'pessanha', '2023-03-29', 7, 'rua quinze', 8463, '105333699', '168590669')
, ('45506365798', 'paula', 'ribeiro', '2023-03-30', 8, 'rua são francisco ', 6572, '819037434', '0')
, ('11423428746', 'paula', 'ribeiro', '2023-03-31', 8, 'rua sete de setembro ', 4218, '730517155', '0')
